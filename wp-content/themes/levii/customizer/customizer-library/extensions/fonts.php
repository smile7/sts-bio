...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'levii' ),
		'cyrillic'     => __( 'Cyrillic', 'levii' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'levii' ),
		'devanagari'   => __( 'Devanagari', 'levii' ),
		'greek'        => __( 'Greek', 'levii' ),
		'greek-ext'    => __( 'Greek Extended', 'levii' ),
		'khmer'        => __( 'Khmer', 'levii' ),
		'latin'        => __( 'Latin', 'levii' ),
		'latin-ext'    => __( 'Latin Extended', 'levii' ),
		'vietnamese'   => __( 'Vietnamese', 'levii' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'levii' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'levii' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'levii' ),
