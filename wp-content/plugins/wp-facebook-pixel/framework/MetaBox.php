...
if( ! function_exists( 'nsa_wpfbp_metabox' ) ) {
    ...
    function nsa_wpfbp_metabox() {
		...
		$cmb = new_cmb2_box( array(
			'id'               => $metabox_ID,
			'title'            => __( 'WP Facebook Pixel Post Settings', wp_facebook_pixel::PLUGIN_ID ),
        ...
        if(class_exists( 'WooCommerce' )) {
            $description .= '
                <br />NOTE: WP Facebook Pixel automatically adds Standard Events for the WooCommerce actions.<br />For more information, visit <a href="http://nightshiftapps.com/wp-facebook-pixel/" target="_blank">Our Integration Page</a><br />';
        }
