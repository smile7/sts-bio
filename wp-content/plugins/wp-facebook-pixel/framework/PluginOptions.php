...
add_filter(wp_facebook_pixel::PLUGIN_ID.'_settings_tabs', 
    function ($val) {
        ...
        $description = __('General settings for the WP Facebook Pixel.', wp_facebook_pixel::PLUGIN_ID );
        ...
        $cmb = array(
            ...
            'fields' => array(
                ...
                array (
                    'name' => __( '<em>Pro Feature</em><br />Delay ViewContent Event', wp_facebook_pixel::PLUGIN_ID ),
                    'desc' => __( 'Delay the delivery of the ViewContent event until the user has been<br />on the page for more then this many seconds.  Set to "0" to send immediately', wp_facebook_pixel::PLUGIN_ID ),
