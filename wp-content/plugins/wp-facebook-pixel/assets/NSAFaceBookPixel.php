...
class NSAFaceBookPixel
{
    ...
    public function insert_Main_Pixel() {
        ...
        if($this->doAddPixel()) {
            ...
            $pixel_Code = "
                ...
                /></noscript>
                <!-- End WP Facebook Pixel Code - Main -->";
    ...
    public function getEvents() {
        echo "<!-- WP Facebook Pixel Code - Page Events -->";
        if($this->doAddPixel()) {
        ...
        echo "<!-- END WP Facebook Pixel Code - Page Events -->";
    }
    ...
    public function get_WooCommerce_Events($events) {
        ...
        if(class_exists('WooCommerce')) {
            ...
            $prefix = wp_facebook_pixel::PLUGIN_ID.'_metabox_';
            global $post;
            if(isset($post->ID) && is_product()) $product = new WC_Product($post->ID);

            //Product Page: View Content & Add To Cart
            if (is_product() && isset($product)) {
                

                $id = $WPFacebookPixel->Product_Id == 'data-product_id' ? $post->ID : $product->get_sku();
