<?php
/**
 * Plugin Name: WP Facebook Pixel
 * Plugin URI: http://nightshiftapps.com/wp-facebook-pixel/
 * Description: Adds the new Facebook Pixel to all pages automatically and allows you to add standard Facebook events on each page.
 * Version: 4.5
 * Author: Night Shift Apps
 * Author URI: http://nightshiftapps.com/wp-facebook-pixel/
 * License: GPL3 or later (Professional version under WP Facebook Pixel Pro License)
 * License URI: http://www.gnu.org/licenses/gpl.html (Professional License: http://nightshiftapps.com/wp-facebook-pixel/wp-facebook-pixel-pro-license/)
...
if ( !file_exists( dirname( __FILE__ ).'/NSA_WP_Plugin.php') ) {
    ...
    add_action( 'admin_notices', function() { 
        echo('<div class="error"><p>
            <strong>WP Facebook Pixel Error:</strong>
            Missing file NSA_WP_Plugin.php.  Please contact Night Shift Apps for assistance or reinstall the plugin.</p></div>'); 
    });
    ...
    class wp_facebook_pixel extends NSA_WP_Plugin {
         ...
         */
        public $PLUGIN_NAME = 'WP Facebook Pixel';
