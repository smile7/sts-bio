...
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=E6TM7T7FSCTQL
Requires at least: 4.0
Tested up to: 4.7.3
Stable tag: trunk
License: GPLv2

Facebook Pixel added to every Page including Standard and WooCommerce Events with custom data.  Easy setup, no coding! WooCommerce 3.0 ready!

== Description ==
= Why choose WP Facebook Pixel =
...
Please visit our WP Facebook Pixel plugin website for more information:
http://nightshiftapps.com/wp-facebook-pixel/
...
Please visit our WP Facebook Pixel support site and forum at
http://nightshiftapps.com/forums/forum/wp-facebook-pixel-support/


== Screenshots ==
1. WP Facebook Pixel General Settings page
2. WP Facebook Pixel Category/Tag tracking.  Allows you to choose specific terms and tags to track.
3. WP Facebook Pixel Meta key tracking.  Allows you to track all keys with 1 click.
4. WP Facebook pixel WooCommerce options.  Enable and disable options on an event by event, page by page basis giving you full control over what is tracked.
5. WP Facebook Pixel Metabox example from a 'Thank you for joining' page.  This includes the product the customer was interested in when signing up and a referral ID whose value is obtained from the query string parameter 'refid'

== Changelog ==
= Version 4.5 =
Bug

- Restored delivery of Product ID for WooCommerce Products.

= Version 4.4 =
Released 04/06/2017
Optimization

- Added cache to post key lookup to improve admin performance.
